...
## Environments
- Preview: https://main--eds-ue-sample--chifyroy.aem.page/
- Live: https://main--eds-ue-sample--chifyroy.aem.live/
...
1. Open the `eds-ue-sample` directory in your favorite IDE and start coding :)
